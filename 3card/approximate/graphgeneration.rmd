...
pl1 <- comp %>%
  ...
  ggtitle("Approximation with Tolerance 1 vs Actual Values")+
...
fig5<-ggplot(comp, aes(x=1:22100, y=diff)) + 
  ...
  ggtitle("Errors for Tolerance of 0.5") +
  theme(panel.background = element_blank(),
        panel.border = element_rect(color="black",fill=NA,size=1),
        plot.title = element_text(hjust=.5))
...
fig6 <- ggplot(comp, aes(x=1:22100, y=diff3)) + geom_point(color="blue",size=0.7, alpha=0.5) +
  ...
  scale_x_continuous("Cumulative Hands Evaluated") +
  scale_y_continuous("Error") +
  ggtitle("Errors for Tolerance of 0.33, 0.2, and 0.1") +
  theme(panel.background = element_blank(),
        panel.border = element_rect(color="black",fill=NA,size=1),
        plot.title = element_text(hjust=.5))
...
fig7 <- ggplot(times,aes(x=Tolerance, y=Time)) + 
  ...
  ggtitle("Times Required to Run Approximation (log scales)") +
  theme(panel.background = element_blank(),
        panel.border = element_rect(color="black",fill=NA,size=1),
        plot.title = element_text(hjust=.5))
...
fig8 <- a.4.1 %>%
  ...
  ggtitle("Estimated E for 4-Card Rummy with Tolerance 1") +
  theme(panel.background = element_blank(),
        panel.border = element_rect(color="black",fill=NA,size=1),
        plot.title = element_text(hjust=.5))
